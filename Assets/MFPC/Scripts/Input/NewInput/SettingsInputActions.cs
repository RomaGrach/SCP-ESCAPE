...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/MFPC/Scripts/Input/NewInput/SettingsInputActions.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""controlSchemes"": []
        ...
        {
            UnityEngine.Debug.Assert(!m_Settings.enabled, "This will cause a leak and performance issues, SettingsInputActions.Settings.Disable() has not been called.");
        }
        ...
        public struct SettingsActions
        {
            ...
            /// <summary>
            /// Provides access to the underlying input action "Settings/Open".
            /// </summary>
